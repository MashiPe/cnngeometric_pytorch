...
class SynthDatasetOcl(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if (occlusion == 1):
            ...
            new_img[start_y:start_y+new_height , start_x:start_x+new_width] = image[start_y:start_y+new_height , start_x:start_x+new_width]
